...
public class TesterArvoreBB10000 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            System.out.println("Execucao " + (i + 1) + " - Busca inicio ("+ inicial +"): " + tempoDecorrido + " ns");
        ...
        for (int i = 0; i < 5; i++) {
            ...
            System.out.println("Execucao " + (i + 1) + " - Busca medio ("+metade+"): " + tempoDecorrido + " ns");

        }
        
        long mediaB2 = somaB2 / 5;
        System.out.println("Media busca medio ("+metade+"): " + mediaB2 + " ns\n");
        ...
        for (int i = 0; i < 5; i++) {
            ...
            System.out.println("Execucao " + (i + 1) + " - Busca final ("+ultimo+"): " + tempoDecorrido + " ns");
        }
        ...
        int ultimoElemento = valoresRandomBusca[tamanho - 1];
        long somaR2 = 0;
        ...
        for (int i = 0; i < 5; i++) {
            ...
            long inicio = System.nanoTime();
            boolean buscar = arvoreRandomBusca.buscar(ultimoElemento);
            long fim = System.nanoTime();
            long tempo = fim - inicio;
            ...
            somaR2 += tempo;
            System.out.println("Execucao " + (i + 1) + " - Busca ultimo (" + ultimoElemento + "): " + tempo + " ns");
        }
